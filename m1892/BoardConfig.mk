...
PRODUCT_COPY_FILES += $(DEVICE_PATH)/m1892/prebuilt/kernel:Image.gz-dtb
...
BOARD_VENDOR_KERNEL_MODULES := \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/mpq-adapter.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/mpq-dmx-hw-plugin.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/pinctrl-wcd.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/qca_cld3_wlan.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/rdbg.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/snd-soc-cs35l41-spi.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/snd-soc-cs35l41.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/snd-soc-sdm845.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/snd-soc-wcd-mbhc.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/snd-soc-wcd-spi.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/snd-soc-wcd934x.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/snd-soc-wcd9xxx.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/swr-wcd-ctrl.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/tspp.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/wcd-core.ko \
    $(DEVICE_PATH)/m1892/prebuilt/vendor-modules/wcd-dsp-glink.ko
